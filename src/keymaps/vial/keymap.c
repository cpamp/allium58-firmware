...
static void render_logo(void) {
  static const char PROGMEM logo[] = {
    ...
    0xD5, 0xD7, 0xD7, 0xD7, 0xD7, 0xD7, 0xD7, 0xD7, 0xD7, 0xD7, 0xD7, 0xD7, 0xD7, 0xD7, 0xD7, 0xD7, 0xD7, 0xD7, 0xD7, 0xD7, 0xD6, 0x00 
  };
...
void render_gui_swap(void) {
  static const char PROGMEM osx_top[] = { 0x95, 0x96, 0x00 };
  static const char PROGMEM osx_bot[] = { 0xB5, 0xB6, 0x00 };
  static const char PROGMEM win_top[] = { 0x97, 0x98, 0x00 };
  static const char PROGMEM win_bot[] = { 0xB7, 0xB8, 0x00 };

  if (keymap_config.swap_lctl_lgui || keymap_config.swap_rctl_rgui) {
    oled_set_cursor(0, 2);
    oled_write_P(osx_top, false);
    oled_set_cursor(0, 3);
    oled_write_P(osx_bot, false);
  } else {
    oled_set_cursor(0, 2);
    oled_write_P(win_top, false);
    oled_set_cursor(0, 3);
    oled_write_P(win_bot, false);
  }
}
#endif // SHOW_GUI_CTL_SWAP
